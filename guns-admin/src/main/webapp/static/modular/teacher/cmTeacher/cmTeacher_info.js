 ...
 * 验证数据是否为空
 */
CmTeacherInfoDlg.validate = function () {
    $('#teauserInfoForm').data("bootstrapValidator").resetForm();
    $('#teauserInfoForm').bootstrapValidator('validate');
    return $("#teauserInfoForm").data('bootstrapValidator').isValid();
};

$(function() {
    Feng.initValidator("teauserInfoForm", CmTeacherInfoDlg.validateFields);
});
