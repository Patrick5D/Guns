 ...
 * 验证数据是否为空
 */
CmPmInfoDlg.validate = function () {
    $('#PMuserInfoForm').data("bootstrapValidator").resetForm();
    $('#PMuserInfoForm').bootstrapValidator('validate');
    return $("#PMuserInfoForm").data('bootstrapValidator').isValid();
};

$(function() {
    Feng.initValidator("PMuserInfoForm", CmPmInfoDlg.validateFields);
});
