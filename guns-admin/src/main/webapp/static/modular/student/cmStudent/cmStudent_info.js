...
CmStudentInfoDlg.validate = function () {
    $('#stuuserInfoForm').data("bootstrapValidator").resetForm();
    $('#stuuserInfoForm').bootstrapValidator('validate');
    return $("#stuuserInfoForm").data('bootstrapValidator').isValid();
};

$(function() {
    Feng.initValidator("stuuserInfoForm", CmStudentInfoDlg.validateFields);
});
