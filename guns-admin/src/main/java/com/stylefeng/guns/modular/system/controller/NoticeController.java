...
//    @ResponseBody
//    public Object list2(String condition,Integer deptid) {
//        EntityWrapper<Notice> noticeEntityWrapper = new EntityWrapper<>();
//        Wrapper<Notice> personalNotice = noticeEntityWrapper.eq("creater",ShiroKit.getUser().getId());
//        List<Notice> notices = noticeService.selectList(noticeEntityWrapper);
////        return super.warpObject(new NoticeWrapper(list));
//        return notices;
//    }
...
//        return super.warpObject(new NoticeWrapper(list));
        ...
        List<Notice> notices = noticeService.selectList(noticeEntityWrapper);
            ...
            for(int i=0;i<notices.size();i++){
                mp = BeanKit.beanToMap(notices.get(i));
                if(mp!=null){
                    stringObjectMap.add(mp);
                }
            }
            return super.warpObject(new NoticeWrapper(stringObjectMap));
