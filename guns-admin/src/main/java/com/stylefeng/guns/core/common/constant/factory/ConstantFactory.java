...
public class ConstantFactory implements IConstantFactory {
    ...
    @Override
    public String getIfLockName(Integer ifLock) {
        return getDictsByName("是否锁定", ifLock);
    }

    @Override
    public String getIfAuditName(Integer ifAudit) {
        return getDictsByName("是否批改", ifAudit);
    }
